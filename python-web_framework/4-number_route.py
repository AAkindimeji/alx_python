...
# -----------------------------------------------------------------------------
# Define a route for paths starting with "/number/" and capture an integer value
# -----------------------------------------------------------------------------
@app.route("/number/<int:n>", strict_slashes=False)
def number_route(n):
    """
    Process paths starting with "/number/" and capture an integer value as "n".
    Return a string confirming that the captured value is a number.
    """
